<?php
	...
	class Hoteles {
		...
		public function getHabitaciones($hoteles_id) {
			
			$conexion = Conexion::conexionBD();

			$sql = "SELECT COUNT(*) FROM habitaciones WHERE hoteles_id = '$hoteles_id'";
		...
		public static function insertarHotel($id, $nombre, $descripcion, $ciudad, $calle, $numero, $cod_postal, $estrellas, $garaje, $piscina, $aire_acondicionado, $wifi) {
