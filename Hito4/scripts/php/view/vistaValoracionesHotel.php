...
<html lang="es">
	...
	<body>
		...
		<main class="container-fluid">
								...
								<thead>
									<tr>
										<td class="text-center" colspan="2">
											Conoce todas las valoraciones de usuarios que se han alojado en el hotel <b><?=$hotel->getNombre()?></b>
										</td>
									</tr>
			...
			<header class="row justify-content-center mt-5 mb-4">
				<h3 class="text-center mt-5">Lo sentimos. Por el momento no hay valoraciones del hotel <?=$hotel->getNombre()?>.</h3>
			</header>
