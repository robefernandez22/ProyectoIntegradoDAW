	...
	<body>
		...
		<main class="container-fluid">
			...
			<div class="alert alert-danger text-center mt-5" role="alert">
				<strong>Vaya...</strong> No se ha podido eliminar el usuario, contacte con el administrador de la base de datos.
				<a href="./delVariable.php?controlador=./verUsuarios.php&variable=eliminacion" class="float-right" aria-hidden="true"><h3>&times;</h3></a>
			</div>
			...
			<div class="alert alert-danger text-center mt-5" role="alert">
				<strong>Vaya...</strong> No se ha podido añadir el usuario, contacte con el administrador de la base de datos.
				<a href="./delVariable.php?controlador=./verUsuarios.php&variable=aniadir" class="float-right" aria-hidden="true"><h3>&times;</h3></a>
			</div>
			...
			<header class="row justify-content-center mt-5">
				<div class="col-md-12">
					...
					<form method="post" id="filtrado" action="./verUsuarios.php">
						<div class="row">
							<div class="col-md-4">
						...
						<table class="table">
							...
							?>
								<tr>
									...
									<td>
										<a href="./setPassword.php?id=<?=base64_encode($usuarios->getCorreo())?>&controlador=verUsuarios.php">Cambiar contraseña</a>
									</td>
								</tr>
							<?php
								}
